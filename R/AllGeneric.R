setGeneric("addFeatureData",             function(object, ...) standardGeneric("addFeatureData"))
...
setGeneric("plotSnp",        function(object, chromosomes, samples, ...) standardGeneric("plotSnp"))
setGeneric("probeSetId", function(object) standardGeneric("probeSetId"))
setGeneric("snpSetList", function(object) standardGeneric("snpSetList"))
